  ...
  async (req, res) => {
    ...
    DECLARE
        ...
        SELECT
            ...
            ISNULL(T2.[Total Ventas sIVA], 0) - ISNULL(T4.[Total NC Valor sIVA], 0) AS 'total' -- DIVISION CLIENTE
            FROM
            (
                SELECT
            ...
            LEFT JOIN (
                ...
                GROUP BY
                DV.[Descripcion General]
            ) AS T2 ON T1.[Descripcion General] = T2.[Descripcion General] -- NOTAS DE CRÉDITO DEVOLUCION sIVA
            ...
            LEFT JOIN (
                ...
                GROUP BY
                DC.[Descripcion General]
            ) AS T4 ON T1.[Descripcion General] = T4.[Descripcion General]
            ORDER BY
            T1.Orden
    `);
